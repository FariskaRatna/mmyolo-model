...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/ppe-coco-train.json',
        data_prefix=dict(img='train_person2024/')))

val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/ppe-coco-test.json',
        data_prefix=dict(img='val_person2024/')))
...
val_evaluator = dict(ann_file=data_root + 'annotations/ppe-coco-test.json')
